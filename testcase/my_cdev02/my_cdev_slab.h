#ifndef _MY_CDEV_SLAB_H
#define _MY_CDEV_SLAB_H
...
mycdrv_generic_lseek(struct file *file, loff_t offset, int orig)
{
	...
	return testpos;
} /* mycdrv_generic_lseek */

static inline int
__init my_generic_init(void)
{
